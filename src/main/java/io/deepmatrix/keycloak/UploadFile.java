...
public class UploadFile {
    private static final String TUS_SERVER_URL = "http://0.0.0.0:1080/files/";
    ...
    public void uploadFile() throws ProtocolException, IOException{
